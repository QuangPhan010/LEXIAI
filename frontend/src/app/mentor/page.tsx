  ...
  return (
    <div className="bg-background text-foreground h-screen flex flex-col overflow-hidden">
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full pt-28 pb-6 px-4 md:px-8 flex flex-col gap-4 overflow-hidden">
        {/* Chat Header */}
        <div className="flex items-center justify-between glass p-4 rounded-2xl border-accent/20">
        ...
        {/* Chat Area */}
        <div className="flex-1 glass rounded-2xl border-white/5 flex flex-col overflow-hidden relative">
          <div 
            ref={scrollRef}
          ...
          <div className="p-4 md:p-6 border-t border-white/5">
            <div className="relative">
              <textarea
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-4 pr-14 text-sm focus:outline-none focus:ring-1 focus:ring-accent transition-all resize-none min-h-[60px] max-h-[120px]"
                rows={1}
              />
              <button
                ...
                suppressHydrationWarning
                className="absolute right-3 bottom-3 p-2.5 premium-gradient rounded-xl text-white shadow-lg disabled:opacity-50 hover-glow transition-all"
              >
                <Send size={18} />
              </button>
            </div>
