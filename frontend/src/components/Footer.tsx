...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto border-t border-zinc-300 dark:border-white/10 bg-background/95 backdrop-blur-md shadow-[0_-1px_0_rgba(0,0,0,0.05)] dark:shadow-[0_-1px_0_rgba(255,255,255,0.05)]">
